<script lang="ts">
    ...
    }: { currentPage: DashboardPage; isOpen?: boolean } = $props();
</script>

<!-- Desktop Sidebar -->
<div class="hidden w-64 rounded-lg border-r bg-card md:block">
    <div class="p-6">
...
{#if isOpen}
    <div class="fixed inset-0 z-50 md:hidden">
        ...
        <!-- Sidebar -->
        <div class="fixed top-0 left-0 h-full w-64 border-r bg-card">
