<script lang="ts">
    ...
    const isFormValid = $derived(
        passwordErrors.length === 0 && !confirmPasswordError && password && confirmPassword
    );
</script>
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="grid gap-3">
                        ...
                        {#if passwordErrors.length > 0}
                            <div class="space-y-1 text-sm text-red-500">
                    ...
                    <div class="grid gap-3">
                        ...
                        {#if confirmPasswordError}
                            <div class="text-sm text-red-500">{confirmPasswordError}</div>
                        {/if}
                    </div>
                    <Button type="submit" class="w-full" disabled={!isFormValid}>Register</Button>
                    <div
